...
public class SistemasNumericos {
    public static void main(String[] args) {
        ...
        int numeroBinario = 0b111110100; // hay que poner un '0b' al inicio para que asuma que es binario
        System.out.println("numeroBinario = " + numeroBinario);
        String resultadoOctal = "numero Octal de " + numeroDecimal + " es " + Integer.toOctalString(numeroDecimal);
        System.out.println(resultadoOctal);

        int numeroOctal = 0764; // Agrega 0 al inicio para que sea un sistema Octal
        System.out.println("numeroOctal = " + numeroOctal);
        String resultadoHex = "numero Hexadecimal de " + numeroDecimal + " es " + Integer.toHexString(numeroDecimal);
        System.out.println(resultadoHex);

        int numeroHex = 0x1f4;  // Se agrega '0x' al inicio para que lo interprete como hexadecimal
